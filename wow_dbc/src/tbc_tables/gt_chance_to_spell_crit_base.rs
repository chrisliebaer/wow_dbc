...
impl From<gtChanceToSpellCritBase> for TbcTable {
    fn from(val: gtChanceToSpellCritBase) -> Self {
        Self::gtChanceToSpellCritBase(val)
    }
}
...
mod test {
    ...
    fn gt_chance_to_spell_crit_base() {
        let contents = include_bytes!("../../../tbc-dbc/gtChanceToSpellCritBase.dbc");
