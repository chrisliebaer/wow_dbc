...
impl SpellItemEnchantment {
    ...
    pub fn verify(&self, item_visuals: &ItemVisuals, spell_item_enchantment_condition: &SpellItemEnchantmentCondition) -> Result<(), crate::InvalidForeignKeyError<&SpellItemEnchantmentRow>> {
