...
pub type MailTemplateKey = crate::PrimaryKey<i32, MailTemplate>;
...
impl Into<TbcTable> for MailTemplate {
    fn into(self) -> TbcTable {
        TbcTable::MailTemplate(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for MailTemplate {
    type Table = Self;
