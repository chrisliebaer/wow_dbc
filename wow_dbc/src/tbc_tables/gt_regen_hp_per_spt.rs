...
impl gtRegenHPPerSpt {
    pub const FILENAME: &'static str = "gtRegenHPPerSpt.dbc";
    pub const FIELD_COUNT: usize = 1;
    pub const ROW_SIZE: usize = 4;

}

impl Into<TbcTable> for gtRegenHPPerSpt {
    fn into(self) -> TbcTable {
        TbcTable::gtRegenHPPerSpt(self)
    }
}
...
impl DbcTable for gtRegenHPPerSpt {
    ...
    fn rows(&self) -> &[gtRegenHPPerSptRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [gtRegenHPPerSptRow] { &mut self.rows }
...
impl DbcRow for gtRegenHPPerSptRow {
}
