...
pub type ChatChannelsKey = crate::PrimaryKey<i32, ChatChannels>;
...
impl Into<TbcTable> for ChatChannels {
    fn into(self) -> TbcTable {
        TbcTable::ChatChannels(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ChatChannels {
    type Table = Self;
