...
impl From<ItemExtendedCost> for TbcTable {
    fn from(val: ItemExtendedCost) -> Self {
        Self::ItemExtendedCost(val)
    }
}
...
mod test {
    ...
    fn item_extended_cost() {
        let contents = include_bytes!("../../../tbc-dbc/ItemExtendedCost.dbc");
