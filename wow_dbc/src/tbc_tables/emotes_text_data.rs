...
pub type EmotesTextDataKey = crate::PrimaryKey<i32, EmotesTextData>;
...
impl Into<TbcTable> for EmotesTextData {
    fn into(self) -> TbcTable {
        TbcTable::EmotesTextData(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for EmotesTextData {
    type Table = Self;
