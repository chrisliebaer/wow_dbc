...
pub type WorldStateUIKey = crate::PrimaryKey<i32, WorldStateUI>;
...
impl WorldStateUI {
    ...
    pub const FIELD_COUNT: usize = 63;
    pub const ROW_SIZE: usize = 252;

    pub fn verify(&self, area_table: &AreaTable, faction: &Faction, map: &Map) -> Result<(), crate::InvalidForeignKeyError<&WorldStateUIRow>> {
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for WorldStateUI {
    type Table = Self;
