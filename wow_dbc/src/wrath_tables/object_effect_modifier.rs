...
impl From<ObjectEffectModifier> for WrathTable {
    fn from(val: ObjectEffectModifier) -> Self {
        Self::ObjectEffectModifier(val)
    }
}
...
mod test {
    ...
    fn object_effect_modifier() {
        let contents = include_bytes!("../../../wrath-dbc/ObjectEffectModifier.dbc");
