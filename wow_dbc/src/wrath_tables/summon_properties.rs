...
impl From<SummonProperties> for WrathTable {
    fn from(val: SummonProperties) -> Self {
        Self::SummonProperties(val)
    }
}
...
mod test {
    ...
    fn summon_properties() {
        let contents = include_bytes!("../../../wrath-dbc/SummonProperties.dbc");
