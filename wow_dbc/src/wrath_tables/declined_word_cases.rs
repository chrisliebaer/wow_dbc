...
impl From<DeclinedWordCases> for WrathTable {
    fn from(val: DeclinedWordCases) -> Self {
        Self::DeclinedWordCases(val)
    }
}
...
mod test {
    ...
    fn declined_word_cases() {
        let contents = include_bytes!("../../../wrath-dbc/DeclinedWordCases.dbc");
