...
impl From<SpellDescriptionVariables> for WrathTable {
    fn from(val: SpellDescriptionVariables) -> Self {
        Self::SpellDescriptionVariables(val)
    }
}
...
mod test {
    ...
    fn spell_description_variables() {
        let contents = include_bytes!("../../../wrath-dbc/SpellDescriptionVariables.dbc");
