...
pub type ItemRandomPropertiesKey = crate::PrimaryKey<i32, ItemRandomProperties>;
...
impl Into<WrathTable> for ItemRandomProperties {
    fn into(self) -> WrathTable {
        WrathTable::ItemRandomProperties(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ItemRandomProperties {
    type Table = Self;
