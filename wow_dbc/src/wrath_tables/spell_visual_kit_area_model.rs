...
impl From<SpellVisualKitAreaModel> for WrathTable {
    fn from(val: SpellVisualKitAreaModel) -> Self {
        Self::SpellVisualKitAreaModel(val)
    }
}
...
mod test {
    ...
    fn spell_visual_kit_area_model() {
        let contents = include_bytes!("../../../wrath-dbc/SpellVisualKitAreaModel.dbc");
