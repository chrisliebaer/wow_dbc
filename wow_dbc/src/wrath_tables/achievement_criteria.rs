...
impl From<Achievement_Criteria> for WrathTable {
    fn from(val: Achievement_Criteria) -> Self {
        Self::Achievement_Criteria(val)
    }
}
...
mod test {
    ...
    fn achievement_criteria() {
        let contents = include_bytes!("../../../wrath-dbc/Achievement_Criteria.dbc");
