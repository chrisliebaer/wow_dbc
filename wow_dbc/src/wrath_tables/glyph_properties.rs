...
impl From<GlyphProperties> for WrathTable {
    fn from(val: GlyphProperties) -> Self {
        Self::GlyphProperties(val)
    }
}
...
mod test {
    ...
    #[test]
    fn glyph_properties() {
        let contents = include_bytes!("../../../wrath-dbc/GlyphProperties.dbc");
