...
impl From<TransportRotation> for WrathTable {
    fn from(val: TransportRotation) -> Self {
        Self::TransportRotation(val)
    }
}
...
mod test {
    ...
    fn transport_rotation() {
        let contents = include_bytes!("../../../wrath-dbc/TransportRotation.dbc");
