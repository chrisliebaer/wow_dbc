...
pub type ChatProfanityKey = crate::PrimaryKey<i32, ChatProfanity>;
...
impl Into<WrathTable> for ChatProfanity {
    fn into(self) -> WrathTable {
        WrathTable::ChatProfanity(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ChatProfanity {
    type Table = Self;
