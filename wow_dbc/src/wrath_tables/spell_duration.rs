...
pub type SpellDurationKey = crate::PrimaryKey<i32, SpellDuration>;
...
impl Into<WrathTable> for SpellDuration {
    fn into(self) -> WrathTable {
        WrathTable::SpellDuration(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for SpellDuration {
    type Table = Self;
