...
impl From<VehicleUIIndSeat> for WrathTable {
    fn from(val: VehicleUIIndSeat) -> Self {
        Self::VehicleUIIndSeat(val)
    }
}
...
mod test {
    ...
    fn vehicle_ui_ind_seat() {
        let contents = include_bytes!("../../../wrath-dbc/VehicleUIIndSeat.dbc");
