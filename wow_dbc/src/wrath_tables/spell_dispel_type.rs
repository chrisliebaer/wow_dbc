...
pub type SpellDispelTypeKey = crate::PrimaryKey<i32, SpellDispelType>;
...
impl Into<WrathTable> for SpellDispelType {
    fn into(self) -> WrathTable {
        WrathTable::SpellDispelType(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for SpellDispelType {
    type Table = Self;
