...
impl From<BarberShopStyle> for WrathTable {
    fn from(val: BarberShopStyle) -> Self {
        Self::BarberShopStyle(val)
    }
}
...
mod test {
    ...
    fn barber_shop_style() {
        let contents = include_bytes!("../../../wrath-dbc/BarberShopStyle.dbc");
