...
pub type GroundEffectTextureKey = crate::PrimaryKey<i32, GroundEffectTexture>;
...
impl Into<WrathTable> for GroundEffectTexture {
    fn into(self) -> WrathTable {
        WrathTable::GroundEffectTexture(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for GroundEffectTexture {
    type Table = Self;
