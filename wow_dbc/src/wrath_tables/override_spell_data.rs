...
impl From<OverrideSpellData> for WrathTable {
    fn from(val: OverrideSpellData) -> Self {
        Self::OverrideSpellData(val)
    }
}
...
mod test {
    ...
    fn override_spell_data() {
        let contents = include_bytes!("../../../wrath-dbc/OverrideSpellData.dbc");
