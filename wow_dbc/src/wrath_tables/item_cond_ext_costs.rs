...
impl From<ItemCondExtCosts> for WrathTable {
    fn from(val: ItemCondExtCosts) -> Self {
        Self::ItemCondExtCosts(val)
    }
}
...
mod test {
    ...
    fn item_cond_ext_costs() {
        let contents = include_bytes!("../../../wrath-dbc/ItemCondExtCosts.dbc");
