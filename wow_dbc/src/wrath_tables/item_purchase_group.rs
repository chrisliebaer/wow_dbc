...
impl From<ItemPurchaseGroup> for WrathTable {
    fn from(val: ItemPurchaseGroup) -> Self {
        Self::ItemPurchaseGroup(val)
    }
}
...
mod test {
    ...
    fn item_purchase_group() {
        let contents = include_bytes!("../../../wrath-dbc/ItemPurchaseGroup.dbc");
