...
impl From<HolidayDescriptions> for WrathTable {
    fn from(val: HolidayDescriptions) -> Self {
        Self::HolidayDescriptions(val)
    }
}
...
mod test {
    ...
    fn holiday_descriptions() {
        let contents = include_bytes!("../../../wrath-dbc/HolidayDescriptions.dbc");
