...
impl From<LFGDungeonGroup> for WrathTable {
    fn from(val: LFGDungeonGroup) -> Self {
        Self::LFGDungeonGroup(val)
    }
}
...
mod test {
    ...
    fn lfg_dungeon_group() {
        let contents = include_bytes!("../../../wrath-dbc/LFGDungeonGroup.dbc");
