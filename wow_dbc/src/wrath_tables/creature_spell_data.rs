...
impl From<CreatureSpellData> for WrathTable {
    fn from(val: CreatureSpellData) -> Self {
        Self::CreatureSpellData(val)
    }
}
...
mod test {
    ...
    fn creature_spell_data() {
        let contents = include_bytes!("../../../wrath-dbc/CreatureSpellData.dbc");
