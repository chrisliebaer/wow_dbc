...
impl From<WorldMapTransforms> for WrathTable {
    fn from(val: WorldMapTransforms) -> Self {
        Self::WorldMapTransforms(val)
    }
}
...
mod test {
    ...
    fn world_map_transforms() {
        let contents = include_bytes!("../../../wrath-dbc/WorldMapTransforms.dbc");
