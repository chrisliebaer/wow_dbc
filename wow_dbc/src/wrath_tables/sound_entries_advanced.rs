...
impl From<SoundEntriesAdvanced> for WrathTable {
    fn from(val: SoundEntriesAdvanced) -> Self {
        Self::SoundEntriesAdvanced(val)
    }
}
...
mod test {
    ...
    fn sound_entries_advanced() {
        let contents = include_bytes!("../../../wrath-dbc/SoundEntriesAdvanced.dbc");
