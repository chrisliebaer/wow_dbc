...
pub type GMSurveyQuestionsKey = crate::PrimaryKey<i32, GMSurveyQuestions>;
...
impl Into<WrathTable> for GMSurveyQuestions {
    fn into(self) -> WrathTable {
        WrathTable::GMSurveyQuestions(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for GMSurveyQuestions {
    type Table = Self;
