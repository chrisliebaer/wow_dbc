...
impl From<ItemLimitCategory> for WrathTable {
    fn from(val: ItemLimitCategory) -> Self {
        Self::ItemLimitCategory(val)
    }
}
...
mod test {
    ...
    fn item_limit_category() {
        let contents = include_bytes!("../../../wrath-dbc/ItemLimitCategory.dbc");
