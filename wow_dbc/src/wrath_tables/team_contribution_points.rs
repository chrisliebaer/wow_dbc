...
impl From<TeamContributionPoints> for WrathTable {
    fn from(val: TeamContributionPoints) -> Self {
        Self::TeamContributionPoints(val)
    }
}
...
mod test {
    ...
    fn team_contribution_points() {
        let contents = include_bytes!("../../../wrath-dbc/TeamContributionPoints.dbc");
