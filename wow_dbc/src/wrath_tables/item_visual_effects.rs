...
pub type ItemVisualEffectsKey = crate::PrimaryKey<i32, ItemVisualEffects>;
...
impl Into<WrathTable> for ItemVisualEffects {
    fn into(self) -> WrathTable {
        WrathTable::ItemVisualEffects(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ItemVisualEffects {
    type Table = Self;
