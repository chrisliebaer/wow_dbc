...
impl From<CreatureMovementInfo> for WrathTable {
    fn from(val: CreatureMovementInfo) -> Self {
        Self::CreatureMovementInfo(val)
    }
}
...
mod test {
    ...
    fn creature_movement_info() {
        let contents = include_bytes!("../../../wrath-dbc/CreatureMovementInfo.dbc");
