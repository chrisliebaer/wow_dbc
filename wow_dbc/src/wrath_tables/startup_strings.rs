...
pub type Startup_StringsKey = crate::PrimaryKey<i32, Startup_Strings>;
...
impl Into<WrathTable> for Startup_Strings {
    fn into(self) -> WrathTable {
        WrathTable::Startup_Strings(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for Startup_Strings {
    type Table = Self;
