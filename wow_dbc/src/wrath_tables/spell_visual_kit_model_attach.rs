...
impl From<SpellVisualKitModelAttach> for WrathTable {
    fn from(val: SpellVisualKitModelAttach) -> Self {
        Self::SpellVisualKitModelAttach(val)
    }
}
...
mod test {
    ...
    fn spell_visual_kit_model_attach() {
        let contents = include_bytes!("../../../wrath-dbc/SpellVisualKitModelAttach.dbc");
