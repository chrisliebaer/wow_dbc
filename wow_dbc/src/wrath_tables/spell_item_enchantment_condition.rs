...
impl From<SpellItemEnchantmentCondition> for WrathTable {
    fn from(val: SpellItemEnchantmentCondition) -> Self {
        Self::SpellItemEnchantmentCondition(val)
    }
}
...
mod test {
    ...
    fn spell_item_enchantment_condition() {
        let contents = include_bytes!("../../../wrath-dbc/SpellItemEnchantmentCondition.dbc");
