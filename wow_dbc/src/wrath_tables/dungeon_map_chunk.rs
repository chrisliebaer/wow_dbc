...
impl From<DungeonMapChunk> for WrathTable {
    fn from(val: DungeonMapChunk) -> Self {
        Self::DungeonMapChunk(val)
    }
}
...
mod test {
    ...
    fn dungeon_map_chunk() {
        let contents = include_bytes!("../../../wrath-dbc/DungeonMapChunk.dbc");
