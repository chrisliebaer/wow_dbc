...
pub type ServerMessagesKey = crate::PrimaryKey<i32, ServerMessages>;
...
impl Into<WrathTable> for ServerMessages {
    fn into(self) -> WrathTable {
        WrathTable::ServerMessages(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ServerMessages {
    type Table = Self;
