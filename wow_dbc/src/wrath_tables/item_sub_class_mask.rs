...
impl From<ItemSubClassMask> for WrathTable {
    fn from(val: ItemSubClassMask) -> Self {
        Self::ItemSubClassMask(val)
    }
}
...
mod test {
    ...
    fn item_sub_class_mask() {
        let contents = include_bytes!("../../../wrath-dbc/ItemSubClassMask.dbc");
