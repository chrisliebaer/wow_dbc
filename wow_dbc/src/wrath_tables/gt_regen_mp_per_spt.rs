...
impl From<gtRegenMPPerSpt> for WrathTable {
    fn from(val: gtRegenMPPerSpt) -> Self {
        Self::gtRegenMPPerSpt(val)
    }
}
...
mod test {
    ...
    fn gt_regen_mp_per_spt() {
        let contents = include_bytes!("../../../wrath-dbc/gtRegenMPPerSpt.dbc");
