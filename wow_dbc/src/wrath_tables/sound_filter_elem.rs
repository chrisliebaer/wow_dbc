...
impl From<SoundFilterElem> for WrathTable {
    fn from(val: SoundFilterElem) -> Self {
        Self::SoundFilterElem(val)
    }
}
...
mod test {
    ...
    fn sound_filter_elem() {
        let contents = include_bytes!("../../../wrath-dbc/SoundFilterElem.dbc");
