...
impl From<AttackAnimTypes> for WrathTable {
    fn from(val: AttackAnimTypes) -> Self {
        Self::AttackAnimTypes(val)
    }
}
...
mod test {
    ...
    fn attack_anim_types() {
        let contents = include_bytes!("../../../wrath-dbc/AttackAnimTypes.dbc");
