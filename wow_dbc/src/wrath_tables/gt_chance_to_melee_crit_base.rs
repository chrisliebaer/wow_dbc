...
impl From<gtChanceToMeleeCritBase> for WrathTable {
    fn from(val: gtChanceToMeleeCritBase) -> Self {
        Self::gtChanceToMeleeCritBase(val)
    }
}
...
mod test {
    ...
    fn gt_chance_to_melee_crit_base() {
        let contents = include_bytes!("../../../wrath-dbc/gtChanceToMeleeCritBase.dbc");
