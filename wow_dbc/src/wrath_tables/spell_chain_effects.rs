...
pub type SpellChainEffectsKey = crate::PrimaryKey<i32, SpellChainEffects>;
...
impl SpellChainEffects {
    ...
    pub const ROW_SIZE: usize = 177;

}

impl Into<WrathTable> for SpellChainEffects {
    fn into(self) -> WrathTable {
        WrathTable::SpellChainEffects(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for SpellChainEffects {
    type Table = Self;
