...
impl From<QuestFactionReward> for WrathTable {
    fn from(val: QuestFactionReward) -> Self {
        Self::QuestFactionReward(val)
    }
}
...
mod test {
    ...
    fn quest_faction_reward() {
        let contents = include_bytes!("../../../wrath-dbc/QuestFactionReward.dbc");
