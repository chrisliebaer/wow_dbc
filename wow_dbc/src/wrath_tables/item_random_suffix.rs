...
pub type ItemRandomSuffixKey = crate::PrimaryKey<i32, ItemRandomSuffix>;
...
impl ItemRandomSuffix {
    pub const FILENAME: &'static str = "ItemRandomSuffix.dbc";
    pub const FIELD_COUNT: usize = 29;
    pub const ROW_SIZE: usize = 116;

}

impl Into<WrathTable> for ItemRandomSuffix {
    fn into(self) -> WrathTable {
        WrathTable::ItemRandomSuffix(self)
    }
}
...
impl DbcTable for ItemRandomSuffix {
    ...
    fn rows(&self) -> &[ItemRandomSuffixRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [ItemRandomSuffixRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for ItemRandomSuffix {
    type Table = Self;

    fn get(&self, key: &ItemRandomSuffixKey) -> Option<&ItemRandomSuffixRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &ItemRandomSuffixKey) -> Option<&mut ItemRandomSuffixRow> {
...
impl DbcRow for ItemRandomSuffixRow {
}
