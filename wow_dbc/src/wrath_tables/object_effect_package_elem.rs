...
impl From<ObjectEffectPackageElem> for WrathTable {
    fn from(val: ObjectEffectPackageElem) -> Self {
        Self::ObjectEffectPackageElem(val)
    }
}
...
mod test {
    ...
    fn object_effect_package_elem() {
        let contents = include_bytes!("../../../wrath-dbc/ObjectEffectPackageElem.dbc");
