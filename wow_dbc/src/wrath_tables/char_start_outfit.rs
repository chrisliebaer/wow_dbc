...
pub type CharStartOutfitKey = crate::PrimaryKey<i32, CharStartOutfit>;
...
impl CharStartOutfit {
    ...
    pub const FIELD_COUNT: usize = 77;
    pub const ROW_SIZE: usize = 296;
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for CharStartOutfit {
    type Table = Self;
