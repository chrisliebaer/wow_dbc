...
impl From<BattlemasterList> for WrathTable {
    fn from(val: BattlemasterList) -> Self {
        Self::BattlemasterList(val)
    }
}
...
mod test {
    ...
    fn battlemaster_list() {
        let contents = include_bytes!("../../../wrath-dbc/BattlemasterList.dbc");
