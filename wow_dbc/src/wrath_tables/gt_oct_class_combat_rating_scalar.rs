...
impl From<gtOCTClassCombatRatingScalar> for WrathTable {
    fn from(val: gtOCTClassCombatRatingScalar) -> Self {
        Self::gtOCTClassCombatRatingScalar(val)
    }
}
...
mod test {
    ...
    fn gt_oct_class_combat_rating_scalar() {
        let contents = include_bytes!("../../../wrath-dbc/gtOCTClassCombatRatingScalar.dbc");
