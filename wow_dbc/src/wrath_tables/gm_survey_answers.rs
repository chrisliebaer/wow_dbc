...
impl From<GMSurveyAnswers> for WrathTable {
    fn from(val: GMSurveyAnswers) -> Self {
        Self::GMSurveyAnswers(val)
    }
}
...
mod test {
    ...
    fn gm_survey_answers() {
        let contents = include_bytes!("../../../wrath-dbc/GMSurveyAnswers.dbc");
