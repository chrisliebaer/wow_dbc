...
impl From<gtNPCManaCostScaler> for WrathTable {
    fn from(val: gtNPCManaCostScaler) -> Self {
        Self::gtNPCManaCostScaler(val)
    }
}
...
mod test {
    ...
    fn gt_npc_mana_cost_scaler() {
        let contents = include_bytes!("../../../wrath-dbc/gtNPCManaCostScaler.dbc");
