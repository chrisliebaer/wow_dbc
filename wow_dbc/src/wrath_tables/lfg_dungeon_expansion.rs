...
impl From<LFGDungeonExpansion> for WrathTable {
    fn from(val: LFGDungeonExpansion) -> Self {
        Self::LFGDungeonExpansion(val)
    }
}
...
mod test {
    ...
    fn lfg_dungeon_expansion() {
        let contents = include_bytes!("../../../wrath-dbc/LFGDungeonExpansion.dbc");
