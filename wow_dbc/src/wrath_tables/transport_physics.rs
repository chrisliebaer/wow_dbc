...
impl From<TransportPhysics> for WrathTable {
    fn from(val: TransportPhysics) -> Self {
        Self::TransportPhysics(val)
    }
}
...
mod test {
    ...
    fn transport_physics() {
        let contents = include_bytes!("../../../wrath-dbc/TransportPhysics.dbc");
