...
impl From<DestructibleModelData> for WrathTable {
    fn from(val: DestructibleModelData) -> Self {
        Self::DestructibleModelData(val)
    }
}
...
mod test {
    ...
    fn destructible_model_data() {
        let contents = include_bytes!("../../../wrath-dbc/DestructibleModelData.dbc");
