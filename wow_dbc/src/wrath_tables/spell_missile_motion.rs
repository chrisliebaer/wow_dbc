...
impl From<SpellMissileMotion> for WrathTable {
    fn from(val: SpellMissileMotion) -> Self {
        Self::SpellMissileMotion(val)
    }
}
...
mod test {
    ...
    fn spell_missile_motion() {
        let contents = include_bytes!("../../../wrath-dbc/SpellMissileMotion.dbc");
