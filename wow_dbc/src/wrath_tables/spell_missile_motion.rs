...
pub type SpellMissileMotionKey = crate::PrimaryKey<i32, SpellMissileMotion>;
...
impl SpellMissileMotion {
    pub const FILENAME: &'static str = "SpellMissileMotion.dbc";
    pub const FIELD_COUNT: usize = 5;
    pub const ROW_SIZE: usize = 20;

}

impl Into<WrathTable> for SpellMissileMotion {
    fn into(self) -> WrathTable {
        WrathTable::SpellMissileMotion(self)
    }
}
...
impl DbcTable for SpellMissileMotion {
    ...
    fn rows(&self) -> &[SpellMissileMotionRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [SpellMissileMotionRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<i32> for SpellMissileMotion {
    type Table = Self;

    fn get(&self, key: &SpellMissileMotionKey) -> Option<&SpellMissileMotionRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &SpellMissileMotionKey) -> Option<&mut SpellMissileMotionRow> {
...
impl DbcRow for SpellMissileMotionRow {
}
