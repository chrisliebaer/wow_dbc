...
impl From<SpellDifficulty> for WrathTable {
    fn from(val: SpellDifficulty) -> Self {
        Self::SpellDifficulty(val)
    }
}
...
mod test {
    ...
    #[test]
    fn spell_difficulty() {
        let contents = include_bytes!("../../../wrath-dbc/SpellDifficulty.dbc");
