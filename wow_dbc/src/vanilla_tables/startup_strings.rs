...
impl From<Startup_Strings> for VanillaTable {
    fn from(val: Startup_Strings) -> Self {
        Self::Startup_Strings(val)
    }
}
...
mod test {
    ...
    #[test]
    fn startup_strings() {
        let contents = include_bytes!("../../../vanilla-dbc/Startup_Strings.dbc");
