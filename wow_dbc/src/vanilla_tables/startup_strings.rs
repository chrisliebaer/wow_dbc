...
pub type Startup_StringsKey = crate::PrimaryKey<u32, Startup_Strings>;
...
impl Startup_Strings {
    pub const FILENAME: &'static str = "Startup_Strings.dbc";
    pub const FIELD_COUNT: usize = 11;
    pub const ROW_SIZE: usize = 44;

}

impl Into<VanillaTable> for Startup_Strings {
    fn into(self) -> VanillaTable {
        VanillaTable::Startup_Strings(self)
    }
}
...
impl DbcTable for Startup_Strings {
    ...
    fn rows(&self) -> &[Startup_StringsRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [Startup_StringsRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for Startup_Strings {
    type Table = Self;

    fn get(&self, key: &Startup_StringsKey) -> Option<&Startup_StringsRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &Startup_StringsKey) -> Option<&mut Startup_StringsRow> {
...
impl DbcRow for Startup_StringsRow {
}
