...
impl From<SpellItemEnchantment> for VanillaTable {
    fn from(val: SpellItemEnchantment) -> Self {
        Self::SpellItemEnchantment(val)
    }
}
...
mod test {
    ...
    fn spell_item_enchantment() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellItemEnchantment.dbc");
