...
pub type SpellItemEnchantmentKey = crate::PrimaryKey<u32, SpellItemEnchantment>;
...
impl SpellItemEnchantment {
    ...
    pub fn verify(&self, item_visuals: &ItemVisuals) -> Result<(), crate::InvalidForeignKeyError<&SpellItemEnchantmentRow>> {
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for SpellItemEnchantment {
    type Table = Self;
