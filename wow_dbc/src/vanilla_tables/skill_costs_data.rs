...
impl From<SkillCostsData> for VanillaTable {
    fn from(val: SkillCostsData) -> Self {
        Self::SkillCostsData(val)
    }
}
...
mod test {
    ...
    #[test]
    fn skill_costs_data() {
        let contents = include_bytes!("../../../vanilla-dbc/SkillCostsData.dbc");
