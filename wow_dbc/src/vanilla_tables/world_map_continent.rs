...
impl From<WorldMapContinent> for VanillaTable {
    fn from(val: WorldMapContinent) -> Self {
        Self::WorldMapContinent(val)
    }
}
...
mod test {
    ...
    fn world_map_continent() {
        let contents = include_bytes!("../../../vanilla-dbc/WorldMapContinent.dbc");
