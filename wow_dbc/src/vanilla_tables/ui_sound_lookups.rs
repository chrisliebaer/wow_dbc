...
impl From<UISoundLookups> for VanillaTable {
    fn from(val: UISoundLookups) -> Self {
        Self::UISoundLookups(val)
    }
}
...
mod test {
    ...
    #[test]
    fn ui_sound_lookups() {
        let contents = include_bytes!("../../../vanilla-dbc/UISoundLookups.dbc");
