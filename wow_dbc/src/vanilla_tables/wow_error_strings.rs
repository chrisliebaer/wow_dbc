...
impl From<WowError_Strings> for VanillaTable {
    fn from(val: WowError_Strings) -> Self {
        Self::WowError_Strings(val)
    }
}
...
mod test {
    ...
    fn wow_error_strings() {
        let contents = include_bytes!("../../../vanilla-dbc/WowError_Strings.dbc");
