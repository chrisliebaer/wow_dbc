...
pub type SoundSamplePreferencesKey = crate::PrimaryKey<u32, SoundSamplePreferences>;
...
impl Into<VanillaTable> for SoundSamplePreferences {
    fn into(self) -> VanillaTable {
        VanillaTable::SoundSamplePreferences(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for SoundSamplePreferences {
    type Table = Self;
