...
impl From<SoundSamplePreferences> for VanillaTable {
    fn from(val: SoundSamplePreferences) -> Self {
        Self::SoundSamplePreferences(val)
    }
}
...
mod test {
    ...
    fn sound_sample_preferences() {
        let contents = include_bytes!("../../../vanilla-dbc/SoundSamplePreferences.dbc");
