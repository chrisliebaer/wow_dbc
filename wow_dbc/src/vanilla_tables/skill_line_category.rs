...
impl From<SkillLineCategory> for VanillaTable {
    fn from(val: SkillLineCategory) -> Self {
        Self::SkillLineCategory(val)
    }
}
...
mod test {
    ...
    fn skill_line_category() {
        let contents = include_bytes!("../../../vanilla-dbc/SkillLineCategory.dbc");
