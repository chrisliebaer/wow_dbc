...
impl From<SoundWaterType> for VanillaTable {
    fn from(val: SoundWaterType) -> Self {
        Self::SoundWaterType(val)
    }
}
...
mod test {
    ...
    #[test]
    fn sound_water_type() {
        let contents = include_bytes!("../../../vanilla-dbc/SoundWaterType.dbc");
