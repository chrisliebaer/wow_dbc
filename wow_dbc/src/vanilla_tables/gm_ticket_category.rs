...
impl From<GMTicketCategory> for VanillaTable {
    fn from(val: GMTicketCategory) -> Self {
        Self::GMTicketCategory(val)
    }
}
...
mod test {
    ...
    fn gm_ticket_category() {
        let contents = include_bytes!("../../../vanilla-dbc/GMTicketCategory.dbc");
