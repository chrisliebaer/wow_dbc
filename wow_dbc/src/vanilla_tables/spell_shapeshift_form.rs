...
impl From<SpellShapeshiftForm> for VanillaTable {
    fn from(val: SpellShapeshiftForm) -> Self {
        Self::SpellShapeshiftForm(val)
    }
}
...
mod test {
    ...
    fn spell_shapeshift_form() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellShapeshiftForm.dbc");
