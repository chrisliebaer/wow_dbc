...
impl From<TerrainTypeSounds> for VanillaTable {
    fn from(val: TerrainTypeSounds) -> Self {
        Self::TerrainTypeSounds(val)
    }
}
...
mod test {
    ...
    fn terrain_type_sounds() {
        let contents = include_bytes!("../../../vanilla-dbc/TerrainTypeSounds.dbc");
