...
impl From<UnitBloodLevels> for VanillaTable {
    fn from(val: UnitBloodLevels) -> Self {
        Self::UnitBloodLevels(val)
    }
}
...
mod test {
    ...
    fn unit_blood_levels() {
        let contents = include_bytes!("../../../vanilla-dbc/UnitBloodLevels.dbc");
