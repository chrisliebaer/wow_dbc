...
impl From<CreatureFamily> for VanillaTable {
    fn from(val: CreatureFamily) -> Self {
        Self::CreatureFamily(val)
    }
}
...
mod test {
    ...
    #[test]
    fn creature_family() {
        let contents = include_bytes!("../../../vanilla-dbc/CreatureFamily.dbc");
