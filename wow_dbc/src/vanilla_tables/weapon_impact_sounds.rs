...
pub type WeaponImpactSoundsKey = crate::PrimaryKey<u32, WeaponImpactSounds>;
...
impl Into<VanillaTable> for WeaponImpactSounds {
    fn into(self) -> VanillaTable {
        VanillaTable::WeaponImpactSounds(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for WeaponImpactSounds {
    type Table = Self;
