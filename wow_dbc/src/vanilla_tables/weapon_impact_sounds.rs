...
impl From<WeaponImpactSounds> for VanillaTable {
    fn from(val: WeaponImpactSounds) -> Self {
        Self::WeaponImpactSounds(val)
    }
}
...
mod test {
    ...
    fn weapon_impact_sounds() {
        let contents = include_bytes!("../../../vanilla-dbc/WeaponImpactSounds.dbc");
