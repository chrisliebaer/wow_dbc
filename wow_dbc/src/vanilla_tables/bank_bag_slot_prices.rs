...
impl From<BankBagSlotPrices> for VanillaTable {
    fn from(val: BankBagSlotPrices) -> Self {
        Self::BankBagSlotPrices(val)
    }
}
...
mod test {
    ...
    fn bank_bag_slot_prices() {
        let contents = include_bytes!("../../../vanilla-dbc/BankBagSlotPrices.dbc");
