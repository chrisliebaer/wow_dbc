...
pub type SpellDispelTypeKey = crate::PrimaryKey<u32, SpellDispelType>;
...
impl SpellDispelType {
    pub const FILENAME: &'static str = "SpellDispelType.dbc";
    pub const FIELD_COUNT: usize = 12;
    pub const ROW_SIZE: usize = 48;

}

impl Into<VanillaTable> for SpellDispelType {
    fn into(self) -> VanillaTable {
        VanillaTable::SpellDispelType(self)
    }
}
...
impl DbcTable for SpellDispelType {
    ...
    fn rows(&self) -> &[SpellDispelTypeRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [SpellDispelTypeRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for SpellDispelType {
    type Table = Self;

    fn get(&self, key: &SpellDispelTypeKey) -> Option<&SpellDispelTypeRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &SpellDispelTypeKey) -> Option<&mut SpellDispelTypeRow> {
...
impl DbcRow for SpellDispelTypeRow {
}
