...
impl From<SpellDispelType> for VanillaTable {
    fn from(val: SpellDispelType) -> Self {
        Self::SpellDispelType(val)
    }
}
...
mod test {
    ...
    fn spell_dispel_type() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellDispelType.dbc");
