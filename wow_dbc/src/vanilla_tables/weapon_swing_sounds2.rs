...
impl From<WeaponSwingSounds2> for VanillaTable {
    fn from(val: WeaponSwingSounds2) -> Self {
        Self::WeaponSwingSounds2(val)
    }
}
...
mod test {
    ...
    fn weapon_swing_sounds2() {
        let contents = include_bytes!("../../../vanilla-dbc/WeaponSwingSounds2.dbc");
