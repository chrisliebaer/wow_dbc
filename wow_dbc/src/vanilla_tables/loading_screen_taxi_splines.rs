...
impl From<LoadingScreenTaxiSplines> for VanillaTable {
    fn from(val: LoadingScreenTaxiSplines) -> Self {
        Self::LoadingScreenTaxiSplines(val)
    }
}
...
mod test {
    ...
    fn loading_screen_taxi_splines() {
        let contents = include_bytes!("../../../vanilla-dbc/LoadingScreenTaxiSplines.dbc");
