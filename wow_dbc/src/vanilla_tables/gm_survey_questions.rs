...
impl From<GMSurveyQuestions> for VanillaTable {
    fn from(val: GMSurveyQuestions) -> Self {
        Self::GMSurveyQuestions(val)
    }
}
...
mod test {
    ...
    fn gm_survey_questions() {
        let contents = include_bytes!("../../../vanilla-dbc/GMSurveyQuestions.dbc");
