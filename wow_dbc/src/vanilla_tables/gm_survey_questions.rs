...
pub type GMSurveyQuestionsKey = crate::PrimaryKey<u32, GMSurveyQuestions>;
...
impl GMSurveyQuestions {
    pub const FILENAME: &'static str = "GMSurveyQuestions.dbc";
    pub const FIELD_COUNT: usize = 10;
    pub const ROW_SIZE: usize = 40;

}

impl Into<VanillaTable> for GMSurveyQuestions {
    fn into(self) -> VanillaTable {
        VanillaTable::GMSurveyQuestions(self)
    }
}
...
impl DbcTable for GMSurveyQuestions {
    ...
    fn rows(&self) -> &[GMSurveyQuestionsRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [GMSurveyQuestionsRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for GMSurveyQuestions {
    type Table = Self;

    fn get(&self, key: &GMSurveyQuestionsKey) -> Option<&GMSurveyQuestionsRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &GMSurveyQuestionsKey) -> Option<&mut GMSurveyQuestionsRow> {
...
impl DbcRow for GMSurveyQuestionsRow {
}
