...
impl From<SpellFocusObject> for VanillaTable {
    fn from(val: SpellFocusObject) -> Self {
        Self::SpellFocusObject(val)
    }
}
...
mod test {
    ...
    fn spell_focus_object() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellFocusObject.dbc");
