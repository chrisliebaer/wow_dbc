...
impl From<DeathThudLookups> for VanillaTable {
    fn from(val: DeathThudLookups) -> Self {
        Self::DeathThudLookups(val)
    }
}
...
mod test {
    ...
    fn death_thud_lookups() {
        let contents = include_bytes!("../../../vanilla-dbc/DeathThudLookups.dbc");
