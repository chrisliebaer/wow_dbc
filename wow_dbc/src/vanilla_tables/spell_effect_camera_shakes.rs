...
impl From<SpellEffectCameraShakes> for VanillaTable {
    fn from(val: SpellEffectCameraShakes) -> Self {
        Self::SpellEffectCameraShakes(val)
    }
}
...
mod test {
    ...
    fn spell_effect_camera_shakes() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellEffectCameraShakes.dbc");
