...
pub type SpellEffectCameraShakesKey = crate::PrimaryKey<u32, SpellEffectCameraShakes>;
...
impl Into<VanillaTable> for SpellEffectCameraShakes {
    fn into(self) -> VanillaTable {
        VanillaTable::SpellEffectCameraShakes(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for SpellEffectCameraShakes {
    type Table = Self;
