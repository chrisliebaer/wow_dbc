...
impl From<CreatureDisplayInfo> for VanillaTable {
    fn from(val: CreatureDisplayInfo) -> Self {
        Self::CreatureDisplayInfo(val)
    }
}
...
mod test {
    ...
    fn creature_display_info() {
        let contents = include_bytes!("../../../vanilla-dbc/CreatureDisplayInfo.dbc");
