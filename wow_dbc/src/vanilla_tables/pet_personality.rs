...
impl From<PetPersonality> for VanillaTable {
    fn from(val: PetPersonality) -> Self {
        Self::PetPersonality(val)
    }
}
...
mod test {
    ...
    #[test]
    fn pet_personality() {
        let contents = include_bytes!("../../../vanilla-dbc/PetPersonality.dbc");
