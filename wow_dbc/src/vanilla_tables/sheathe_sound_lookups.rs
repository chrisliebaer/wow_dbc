...
impl From<SheatheSoundLookups> for VanillaTable {
    fn from(val: SheatheSoundLookups) -> Self {
        Self::SheatheSoundLookups(val)
    }
}
...
mod test {
    ...
    fn sheathe_sound_lookups() {
        let contents = include_bytes!("../../../vanilla-dbc/SheatheSoundLookups.dbc");
