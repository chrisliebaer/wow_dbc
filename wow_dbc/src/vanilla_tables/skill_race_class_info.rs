...
impl From<SkillRaceClassInfo> for VanillaTable {
    fn from(val: SkillRaceClassInfo) -> Self {
        Self::SkillRaceClassInfo(val)
    }
}
...
mod test {
    ...
    fn skill_race_class_info() {
        let contents = include_bytes!("../../../vanilla-dbc/SkillRaceClassInfo.dbc");
