...
impl From<AttackAnimKits> for VanillaTable {
    fn from(val: AttackAnimKits) -> Self {
        Self::AttackAnimKits(val)
    }
}
...
mod test {
    ...
    #[test]
    fn attack_anim_kits() {
        let contents = include_bytes!("../../../vanilla-dbc/AttackAnimKits.dbc");
