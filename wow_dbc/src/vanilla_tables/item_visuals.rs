...
pub type ItemVisualsKey = crate::PrimaryKey<u32, ItemVisuals>;
...
impl Into<VanillaTable> for ItemVisuals {
    fn into(self) -> VanillaTable {
        VanillaTable::ItemVisuals(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for ItemVisuals {
    type Table = Self;
