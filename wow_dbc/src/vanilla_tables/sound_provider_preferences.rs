...
impl From<SoundProviderPreferences> for VanillaTable {
    fn from(val: SoundProviderPreferences) -> Self {
        Self::SoundProviderPreferences(val)
    }
}
...
mod test {
    ...
    fn sound_provider_preferences() {
        let contents = include_bytes!("../../../vanilla-dbc/SoundProviderPreferences.dbc");
