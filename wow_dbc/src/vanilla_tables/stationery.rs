...
pub type StationeryKey = crate::PrimaryKey<u32, Stationery>;
...
impl Into<VanillaTable> for Stationery {
    fn into(self) -> VanillaTable {
        VanillaTable::Stationery(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for Stationery {
    type Table = Self;
