...
impl From<TransportAnimation> for VanillaTable {
    fn from(val: TransportAnimation) -> Self {
        Self::TransportAnimation(val)
    }
}
...
mod test {
    ...
    fn transport_animation() {
        let contents = include_bytes!("../../../vanilla-dbc/TransportAnimation.dbc");
