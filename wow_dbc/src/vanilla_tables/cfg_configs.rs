...
pub type Cfg_ConfigsKey = crate::PrimaryKey<u32, Cfg_Configs>;
...
impl Into<VanillaTable> for Cfg_Configs {
    fn into(self) -> VanillaTable {
        VanillaTable::Cfg_Configs(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for Cfg_Configs {
    type Table = Self;
