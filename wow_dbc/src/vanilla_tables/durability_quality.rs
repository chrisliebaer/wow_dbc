...
impl From<DurabilityQuality> for VanillaTable {
    fn from(val: DurabilityQuality) -> Self {
        Self::DurabilityQuality(val)
    }
}
...
mod test {
    ...
    fn durability_quality() {
        let contents = include_bytes!("../../../vanilla-dbc/DurabilityQuality.dbc");
