...
impl From<CharHairGeosets> for VanillaTable {
    fn from(val: CharHairGeosets) -> Self {
        Self::CharHairGeosets(val)
    }
}
...
mod test {
    ...
    fn char_hair_geosets() {
        let contents = include_bytes!("../../../vanilla-dbc/CharHairGeosets.dbc");
