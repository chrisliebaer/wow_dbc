...
impl From<CinematicCamera> for VanillaTable {
    fn from(val: CinematicCamera) -> Self {
        Self::CinematicCamera(val)
    }
}
...
mod test {
    ...
    #[test]
    fn cinematic_camera() {
        let contents = include_bytes!("../../../vanilla-dbc/CinematicCamera.dbc");
