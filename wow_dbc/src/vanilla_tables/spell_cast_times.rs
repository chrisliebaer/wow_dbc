...
impl From<SpellCastTimes> for VanillaTable {
    fn from(val: SpellCastTimes) -> Self {
        Self::SpellCastTimes(val)
    }
}
...
mod test {
    ...
    #[test]
    fn spell_cast_times() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellCastTimes.dbc");
