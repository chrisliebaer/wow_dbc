...
impl From<HelmetGeosetVisData> for VanillaTable {
    fn from(val: HelmetGeosetVisData) -> Self {
        Self::HelmetGeosetVisData(val)
    }
}
...
mod test {
    ...
    fn helmet_geoset_vis_data() {
        let contents = include_bytes!("../../../vanilla-dbc/HelmetGeosetVisData.dbc");
