...
impl From<WorldMapOverlay> for VanillaTable {
    fn from(val: WorldMapOverlay) -> Self {
        Self::WorldMapOverlay(val)
    }
}
...
mod test {
    ...
    fn world_map_overlay() {
        let contents = include_bytes!("../../../vanilla-dbc/WorldMapOverlay.dbc");
