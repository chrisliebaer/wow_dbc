...
impl From<SpellChainEffects> for VanillaTable {
    fn from(val: SpellChainEffects) -> Self {
        Self::SpellChainEffects(val)
    }
}
...
mod test {
    ...
    fn spell_chain_effects() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellChainEffects.dbc");
