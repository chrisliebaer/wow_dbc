...
impl From<StableSlotPrices> for VanillaTable {
    fn from(val: StableSlotPrices) -> Self {
        Self::StableSlotPrices(val)
    }
}
...
mod test {
    ...
    fn stable_slot_prices() {
        let contents = include_bytes!("../../../vanilla-dbc/StableSlotPrices.dbc");
