...
impl From<LightFloatBand> for VanillaTable {
    fn from(val: LightFloatBand) -> Self {
        Self::LightFloatBand(val)
    }
}
...
mod test {
    ...
    #[test]
    fn light_float_band() {
        let contents = include_bytes!("../../../vanilla-dbc/LightFloatBand.dbc");
