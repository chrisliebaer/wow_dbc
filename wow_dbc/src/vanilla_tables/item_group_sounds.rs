...
impl From<ItemGroupSounds> for VanillaTable {
    fn from(val: ItemGroupSounds) -> Self {
        Self::ItemGroupSounds(val)
    }
}
...
mod test {
    ...
    fn item_group_sounds() {
        let contents = include_bytes!("../../../vanilla-dbc/ItemGroupSounds.dbc");
