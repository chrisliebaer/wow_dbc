...
impl From<SpellVisualKit> for VanillaTable {
    fn from(val: SpellVisualKit) -> Self {
        Self::SpellVisualKit(val)
    }
}
...
mod test {
    ...
    #[test]
    fn spell_visual_kit() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellVisualKit.dbc");
