...
impl From<ItemVisualEffects> for VanillaTable {
    fn from(val: ItemVisualEffects) -> Self {
        Self::ItemVisualEffects(val)
    }
}
...
mod test {
    ...
    fn item_visual_effects() {
        let contents = include_bytes!("../../../vanilla-dbc/ItemVisualEffects.dbc");
