...
pub type CreatureSpellDataKey = crate::PrimaryKey<u32, CreatureSpellData>;
...
impl Into<VanillaTable> for CreatureSpellData {
    fn into(self) -> VanillaTable {
        VanillaTable::CreatureSpellData(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for CreatureSpellData {
    type Table = Self;
