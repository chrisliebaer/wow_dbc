...
impl From<PaperDollItemFrame> for VanillaTable {
    fn from(val: PaperDollItemFrame) -> Self {
        Self::PaperDollItemFrame(val)
    }
}
...
mod test {
    ...
    fn paper_doll_item_frame() {
        let contents = include_bytes!("../../../vanilla-dbc/PaperDollItemFrame.dbc");
