...
impl From<FootstepTerrainLookup> for VanillaTable {
    fn from(val: FootstepTerrainLookup) -> Self {
        Self::FootstepTerrainLookup(val)
    }
}
...
mod test {
    ...
    fn footstep_terrain_lookup() {
        let contents = include_bytes!("../../../vanilla-dbc/FootstepTerrainLookup.dbc");
