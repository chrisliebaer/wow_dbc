...
pub type ItemRandomPropertiesKey = crate::PrimaryKey<u32, ItemRandomProperties>;
...
impl ItemRandomProperties {
    pub const FILENAME: &'static str = "ItemRandomProperties.dbc";
    pub const FIELD_COUNT: usize = 16;
    pub const ROW_SIZE: usize = 64;

}

impl Into<VanillaTable> for ItemRandomProperties {
    fn into(self) -> VanillaTable {
        VanillaTable::ItemRandomProperties(self)
    }
}
...
impl DbcTable for ItemRandomProperties {
    ...
    fn rows(&self) -> &[ItemRandomPropertiesRow] { &self.rows }
    fn rows_mut(&mut self) -> &mut [ItemRandomPropertiesRow] { &mut self.rows }
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for ItemRandomProperties {
    type Table = Self;

    fn get(&self, key: &ItemRandomPropertiesKey) -> Option<&ItemRandomPropertiesRow> {
        self.rows.iter().find(|a| &a.id == key)
    }

    fn get_mut(&mut self, key: &ItemRandomPropertiesKey) -> Option<&mut ItemRandomPropertiesRow> {
...
impl DbcRow for ItemRandomPropertiesRow {
}
