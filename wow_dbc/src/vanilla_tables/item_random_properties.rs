...
impl From<ItemRandomProperties> for VanillaTable {
    fn from(val: ItemRandomProperties) -> Self {
        Self::ItemRandomProperties(val)
    }
}
...
mod test {
    ...
    fn item_random_properties() {
        let contents = include_bytes!("../../../vanilla-dbc/ItemRandomProperties.dbc");
