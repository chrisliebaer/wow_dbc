...
impl From<ZoneIntroMusicTable> for VanillaTable {
    fn from(val: ZoneIntroMusicTable) -> Self {
        Self::ZoneIntroMusicTable(val)
    }
}
...
mod test {
    ...
    fn zone_intro_music_table() {
        let contents = include_bytes!("../../../vanilla-dbc/ZoneIntroMusicTable.dbc");
