...
pub type DurabilityCostsKey = crate::PrimaryKey<u32, DurabilityCosts>;
...
impl Into<VanillaTable> for DurabilityCosts {
    fn into(self) -> VanillaTable {
        VanillaTable::DurabilityCosts(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for DurabilityCosts {
    type Table = Self;
