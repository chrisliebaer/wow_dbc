...
impl From<DurabilityCosts> for VanillaTable {
    fn from(val: DurabilityCosts) -> Self {
        Self::DurabilityCosts(val)
    }
}
...
mod test {
    ...
    #[test]
    fn durability_costs() {
        let contents = include_bytes!("../../../vanilla-dbc/DurabilityCosts.dbc");
