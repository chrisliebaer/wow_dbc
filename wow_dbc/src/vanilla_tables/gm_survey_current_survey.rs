...
impl From<GMSurveyCurrentSurvey> for VanillaTable {
    fn from(val: GMSurveyCurrentSurvey) -> Self {
        Self::GMSurveyCurrentSurvey(val)
    }
}
...
mod test {
    ...
    fn gm_survey_current_survey() {
        let contents = include_bytes!("../../../vanilla-dbc/GMSurveyCurrentSurvey.dbc");
