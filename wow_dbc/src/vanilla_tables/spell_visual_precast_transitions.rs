...
impl From<SpellVisualPrecastTransitions> for VanillaTable {
    fn from(val: SpellVisualPrecastTransitions) -> Self {
        Self::SpellVisualPrecastTransitions(val)
    }
}
...
mod test {
    ...
    fn spell_visual_precast_transitions() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellVisualPrecastTransitions.dbc");
