...
pub type SpellVisualPrecastTransitionsKey = crate::PrimaryKey<u32, SpellVisualPrecastTransitions>;
...
impl Into<VanillaTable> for SpellVisualPrecastTransitions {
    fn into(self) -> VanillaTable {
        VanillaTable::SpellVisualPrecastTransitions(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for SpellVisualPrecastTransitions {
    type Table = Self;
