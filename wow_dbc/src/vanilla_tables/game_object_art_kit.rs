...
impl From<GameObjectArtKit> for VanillaTable {
    fn from(val: GameObjectArtKit) -> Self {
        Self::GameObjectArtKit(val)
    }
}
...
mod test {
    ...
    fn game_object_art_kit() {
        let contents = include_bytes!("../../../vanilla-dbc/GameObjectArtKit.dbc");
