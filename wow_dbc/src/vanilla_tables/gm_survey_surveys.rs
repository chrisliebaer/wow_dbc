...
pub type GMSurveySurveysKey = crate::PrimaryKey<u32, GMSurveySurveys>;
...
impl Into<VanillaTable> for GMSurveySurveys {
    fn into(self) -> VanillaTable {
        VanillaTable::GMSurveySurveys(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for GMSurveySurveys {
    type Table = Self;
