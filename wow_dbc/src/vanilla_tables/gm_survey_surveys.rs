...
impl From<GMSurveySurveys> for VanillaTable {
    fn from(val: GMSurveySurveys) -> Self {
        Self::GMSurveySurveys(val)
    }
}
...
mod test {
    ...
    fn gm_survey_surveys() {
        let contents = include_bytes!("../../../vanilla-dbc/GMSurveySurveys.dbc");
