...
impl From<ItemDisplayInfo> for VanillaTable {
    fn from(val: ItemDisplayInfo) -> Self {
        Self::ItemDisplayInfo(val)
    }
}
...
mod test {
    ...
    fn item_display_info() {
        let contents = include_bytes!("../../../vanilla-dbc/ItemDisplayInfo.dbc");
