...
impl From<EmotesTextData> for VanillaTable {
    fn from(val: EmotesTextData) -> Self {
        Self::EmotesTextData(val)
    }
}
...
mod test {
    ...
    #[test]
    fn emotes_text_data() {
        let contents = include_bytes!("../../../vanilla-dbc/EmotesTextData.dbc");
