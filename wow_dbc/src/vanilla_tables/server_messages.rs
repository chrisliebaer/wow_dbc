...
impl From<ServerMessages> for VanillaTable {
    fn from(val: ServerMessages) -> Self {
        Self::ServerMessages(val)
    }
}
...
mod test {
    ...
    #[test]
    fn server_messages() {
        let contents = include_bytes!("../../../vanilla-dbc/ServerMessages.dbc");
