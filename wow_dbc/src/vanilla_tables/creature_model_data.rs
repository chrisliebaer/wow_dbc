...
impl From<CreatureModelData> for VanillaTable {
    fn from(val: CreatureModelData) -> Self {
        Self::CreatureModelData(val)
    }
}
...
mod test {
    ...
    fn creature_model_data() {
        let contents = include_bytes!("../../../vanilla-dbc/CreatureModelData.dbc");
