...
impl From<CreatureDisplayInfoExtra> for VanillaTable {
    fn from(val: CreatureDisplayInfoExtra) -> Self {
        Self::CreatureDisplayInfoExtra(val)
    }
}
...
mod test {
    ...
    fn creature_display_info_extra() {
        let contents = include_bytes!("../../../vanilla-dbc/CreatureDisplayInfoExtra.dbc");
