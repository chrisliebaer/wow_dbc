...
impl From<SpellVisualEffectName> for VanillaTable {
    fn from(val: SpellVisualEffectName) -> Self {
        Self::SpellVisualEffectName(val)
    }
}
...
mod test {
    ...
    fn spell_visual_effect_name() {
        let contents = include_bytes!("../../../vanilla-dbc/SpellVisualEffectName.dbc");
