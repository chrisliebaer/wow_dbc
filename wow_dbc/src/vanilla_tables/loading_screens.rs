...
impl From<LoadingScreens> for VanillaTable {
    fn from(val: LoadingScreens) -> Self {
        Self::LoadingScreens(val)
    }
}
...
mod test {
    ...
    #[test]
    fn loading_screens() {
        let contents = include_bytes!("../../../vanilla-dbc/LoadingScreens.dbc");
