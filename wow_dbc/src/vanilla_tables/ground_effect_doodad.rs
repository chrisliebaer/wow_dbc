...
impl From<GroundEffectDoodad> for VanillaTable {
    fn from(val: GroundEffectDoodad) -> Self {
        Self::GroundEffectDoodad(val)
    }
}
...
mod test {
    ...
    fn ground_effect_doodad() {
        let contents = include_bytes!("../../../vanilla-dbc/GroundEffectDoodad.dbc");
