...
pub type VideoHardwareKey = crate::PrimaryKey<u32, VideoHardware>;
...
impl Into<VanillaTable> for VideoHardware {
    fn into(self) -> VanillaTable {
        VanillaTable::VideoHardware(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for VideoHardware {
    type Table = Self;
