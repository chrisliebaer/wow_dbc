...
pub type ItemPetFoodKey = crate::PrimaryKey<u32, ItemPetFood>;
...
impl Into<VanillaTable> for ItemPetFood {
    fn into(self) -> VanillaTable {
        VanillaTable::ItemPetFood(self)
    }
}
...
#[allow(refining_impl_trait)]
impl Indexable<u32> for ItemPetFood {
    type Table = Self;
